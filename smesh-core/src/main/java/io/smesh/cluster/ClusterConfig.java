...
public class ClusterConfig {
    ...
    public static final SmeshProperty TASK_SERVICE_AWAIT_TERMINATION_SECONDS = new SmeshProperty("smesh.cluster.taskService.awaitTerminationSeconds", 0);
    ...
    public String getLocalMemberName() {
        return properties.getRequiredString(CLUSTER_LOCAL_MEMBER_NAME);
    }

    public int getTaskServiceAwaitTerminationSeconds() {
        return properties.getInt(TASK_SERVICE_AWAIT_TERMINATION_SECONDS);
    }
